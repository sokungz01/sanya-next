...
export default function Login({ providers }: { providers: any[] }) {
  return (
    <div className="bg-zinc-100">
      <div className="bg-sign-paper bg-no-repeat bg-right-top bg-blend-overlay">
        <div className="container flex items-center justify-center min-h-screen mx-auto ">
          <div className="backdrop-blur-md w-full max-w-xl bg-white/75 rounded-2xl p-24">
            <form>
              <Image src={sanyaLogo} alt="sanyaLogo" width={150} height={60} />
              ...
              <div className="mt-6">
                ...
                {/* FaceBook Login */}
                <a className="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 cursor-pointer transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
