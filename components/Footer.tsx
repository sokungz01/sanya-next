...
export default function Footer() {
  const allSetting = [
    { title: "คำถามที่พบบ่อย", path: "/most-ask" },
    { title: "ข้อกำหนดและเงื่อนไข", path: "/rule" },
    { title: "นโยบายคุ้มครองส่วนบุคคล", path: "/privacy-policy" },
    { title: "ตั้งค่าคุกกี้", path: "/cookie-setting" },
  ];
  return (
    <div>
      <footer className="bg-topbar dark:bg-gray-900">
        <div className="container p-6 mx-auto">
          <div className="lg:flex">
            <div className="w-full -mx-6 lg:w-2/5">
              <Link href={"/"}>
                <a>
                  <Image src={sanyaLogo} alt="mitr sanya" />
                </a>
              </Link>
            </div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div>
                  ...
                  <p className="mt-3 text-sm text-white">
                    บริษัท มิตรสัญญา จำกัด (สำนักงานใหญ่) เลขที่ 2074/81 ซอย
                    เจริญกรุง แขวงวัดพระยาไกล เขตบางคอแหลม กรุงเทพมหานคร
                    <br />
                    (+66) 64-290-4111 ทุกวัน 9.00 - 18.00 น.
                  </p>
                </div>
                {/* SETTING */}
                <div>
